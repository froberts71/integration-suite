...
echo "bazel build -c opt --config=ubuntu_nostyle scripts/packages:binpkgs" >> docker_command.txt;
echo "bazel build -c opt --config=ubuntu_nostyle scripts/packages:tarpkgs" >> docker_command.txt;
